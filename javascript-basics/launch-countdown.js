// In this exercise, we want you to print out a simple launch countdown to the output box, from 10 down to
// Blastoff. Specifically, we want you to:
//
...
//    using const output = document.querySelector('.output');. In comments, we've provided you with three code
//    lines that need to be used somewhere inside the loop:
